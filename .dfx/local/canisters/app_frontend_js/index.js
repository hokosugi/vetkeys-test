...
import { idlFactory } from './app_frontend_js.did.js';
export { idlFactory } from './app_frontend_js.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_APP_FRONTEND_JS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./app_frontend_js.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the app_frontend_js canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./app_frontend_js.did.js")._SERVICE>}
 */
export const app_frontend_js = createActor(canisterId);
