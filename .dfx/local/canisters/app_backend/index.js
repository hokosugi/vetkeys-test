...
export { idlFactory } from './app_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_APP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./app_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the app_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./app_backend.did.js")._SERVICE>}
 */
export const app_backend = createActor(canisterId);
