...
export const canisterId = process.env.CANISTER_ID_SYSTEM_API;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./system_api.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the system_api canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./system_api.did.js")._SERVICE>}
 */
